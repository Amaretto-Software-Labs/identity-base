...
namespace Identity.Base.Host.SqlServerMigrations.Data.Migrations.Roles
{
    ...
    [Migration("20260720125216_AddServicePrincipalRoles")]
    partial class AddServicePrincipalRoles
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Identity.Base.Roles.Entities.ServicePrincipalRole", b =>
                {
                    ...
                    b.HasIndex("RoleId")
                        .HasDatabaseName("IX_Host_ServicePrincipalRoles_RoleId");

                    b.ToTable("Host_ServicePrincipalRoles", (string)null);
                });

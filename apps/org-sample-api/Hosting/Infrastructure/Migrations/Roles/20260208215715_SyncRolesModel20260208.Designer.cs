...
namespace OrgSampleApi.Hosting.Infrastructure.Migrations.Roles
{
    ...
    [Migration("20260208215715_SyncRolesModel20260208")]
    partial class SyncRolesModel20260208
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Identity.Base.Roles.Entities.AuditEntry", b =>
                {
                    ...
                    b.ToTable("OrgSample_AuditEntries", (string)null);
                });
            ...
            modelBuilder.Entity("Identity.Base.Roles.Entities.Permission", b =>
                {
                    ...
                    b.ToTable("OrgSample_Permissions", (string)null);
                });
            ...
            modelBuilder.Entity("Identity.Base.Roles.Entities.Role", b =>
                {
                    ...
                    b.ToTable("OrgSample_RbacRoles", (string)null);
                });
            ...
            modelBuilder.Entity("Identity.Base.Roles.Entities.UserRole", b =>
                {
                    ...
                    b.HasIndex("RoleId")
                        .HasDatabaseName("IX_OrgSample_UserRolesRbac_RoleId");

                    b.ToTable("OrgSample_UserRolesRbac", (string)null);
                });

        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                ...
                WITH ranked AS (
                    ...
                    FROM "OrgSample_OrganizationInvitations"
                )
                DELETE FROM "OrgSample_OrganizationInvitations" AS invitation
                USING ranked
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrgSample_OrganizationInvitations_OrganizationId_Email",
